...
| **Windows** | ![Windows Build](https://img.shields.io/badge/Windows-EXE-blue?logo=windows) | v1.0.0 | [**Скачать .exe**]([https://github.com/ваш_пользователь/репозиторий/releases/latest](https://github.com/SwordBird2002/S3PrivateCloud/releases/tag/v1.0.0/PrivateCloud.exe)) |
